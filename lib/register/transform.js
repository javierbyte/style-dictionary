...
var transformTypes = ['name', 'value', 'attribute', 'meta'];
 ...
 * @param {String} transform.name - Name of the transformer so a transformGroup can call a list of transforms.
 ...
 * @param {Function} transform.transformer Performs a transform on a property object, should return a string or object depending on the type. Will only update certain properties so you can't mess up property objects on accident.
